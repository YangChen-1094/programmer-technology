...
![快速查找gif](images/1_quick_search.gif)
...
![二分查找](images/1_quick_search.png)
　　插值查找的mid计算公式，des是需要查找的数值：(自适应部分已标红)
![插值查找](images/1_insert_search.png)
```
...
![斐波那契查找](images/1_fibonacci_search.png)
...
![分块查找](images/1_block_search.png)
