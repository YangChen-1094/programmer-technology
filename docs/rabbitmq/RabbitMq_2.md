...
#### 2.3.5、消息丢失（如何保证不丢失）
![消息丢失](../../images/rabbitmq/2_drop.png)
#### ①消息在生产者丢失
###### 原因：
...
###### 解决方案：
* 消费者向MQ的回复**配置成手动ACK**。当消费者出现异常或者服务宕机时，MQ服务器不会删除该消息，而是会把消息重发给绑定该
...
![img.png](../../images/rabbitmq/2_drop_solve.png)
...
![死信队列](../../images/rabbitmq/2_dead_letter.png)
