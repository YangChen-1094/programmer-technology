...
![串行方式](images/rabbitmq/chuanxingfangshi.png)

**(2)并行方式**，如下图
![并行方式](images/rabbitmq/bingxingfangshi.png)
...
![消息队列](images/rabbitmq/xiaoxiduilie.png)
...
![应用间解耦](images/rabbitmq/yingyongjianjieou.png)

######引入消息队列-解耦：
![解耦](images/rabbitmq/jieou.png)
...
![流量削峰](images/rabbitmq/liuliangxiaofeng.png)

####1.4 消息队列优缺点

关于消息队列的优点就是在特殊场景下有其对应的好处，解耦、异步、削峰。缺点有以下几个：
